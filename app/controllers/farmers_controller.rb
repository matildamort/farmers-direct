class FarmersController < ApplicationController
    ...
    def create
        ...
        if @farmers.save #If the farmer can save thier new farm page, it will do so. 
            redirect_to farmers_path

        else #If they are unable to create a farmer page, it will let them know. This is controlled in the model through a validates uniqueness to prevent farmer creating more than one page. 
    ...
    def farmer_params
        params.require(:farmer).permit(:name, :about, :abn, :user_id, photos: [] ) #Regular params, photo is an array and support mulitple picture uploads and assigned to that farmer. 
    end
